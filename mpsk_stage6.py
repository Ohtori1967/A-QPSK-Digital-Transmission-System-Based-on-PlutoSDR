...
class mpsk_stage6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.header_format_default = header_format_default = digital.header_format_default('11111111000000001111111100000000',0, 1)
        self.freq_offset = freq_offset = 0
        self.filepath = filepath = "C:/Users/Ohtori1967/Desktop/qpsk_tx_rx_system/rx"
        ...
        self.iio_pluto_source_0.set_frequency(3800000000)
        ...
        for c in range(1, 2):
            self.controls_grid_layout_1.setColumnStretch(c, 1)
        self.epy_block_0 = epy_block_0.blk(out_dir=filepath, debug=True, overwrite=True, max_buffer=1024)
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_b((0xdb, 0x30, 0xf7, 0x03,), True, 1, [])
        self.blocks_unpack_k_bits_bb_0_0 = blocks.unpack_k_bits_bb(8)
        self.blocks_unpack_k_bits_bb_0 = blocks.unpack_k_bits_bb(2)
        self.blocks_stream_to_tagged_stream_0 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, 512, "frame")
        ...
        self.connect((self.blocks_repack_bits_bb_0, 0), (self.blocks_stream_to_tagged_stream_0, 0))
        ...
        self.connect((self.digital_crc32_bb_0_0, 0), (self.epy_block_0, 0))
    ...
    def set_filepath(self, filepath):
        ...
        self.epy_block_0.out_dir = self.filepath
